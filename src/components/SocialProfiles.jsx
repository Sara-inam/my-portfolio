      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-12">
        ...
        >
          <h3 className="text-2xl sm:text-3xl font-bold text-gray-900">
            Find Me On <span className="bg-gradient-to-r from-purple-600 to-purple-400 bg-clip-text text-transparent">Social</span>
          </h3>
        </motion.div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          {profiles.map((p, i) => (
            <motion.a
              ...
              whileHover={{ y: -4 }}
              className="flex items-center gap-4 p-5 rounded-2xl bg-white border border-purple-100 shadow-sm shadow-purple-100 hover:shadow-md hover:shadow-purple-200 transition-all"
            >
              <span className="text-purple-600">{p.icon}</span>
              <div>
