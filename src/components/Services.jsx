        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
          {services.map((s, i) => (
            <motion.div
              ...
              whileHover={{ y: -6 }}
              className="group relative p-6 sm:p-8 rounded-3xl bg-white border border-purple-100 shadow-sm shadow-purple-100 hover:shadow-md hover:shadow-purple-200 transition-all"
            >
              ...
              <div className="relative z-10">
                <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-2xl bg-gradient-to-br from-purple-500/20 to-purple-500/20 border border-purple-100 flex items-center justify-center mb-4 sm:mb-5 group-hover:scale-110 transition-transform">
                ...
                <div className="flex flex-wrap gap-2">
                  {s.highlights.map((h, idx) => (
                    <span key={idx} className="text-[11px] sm:text-xs px-3 py-1.5 rounded-full bg-purple-50 border border-purple-100 text-gray-600 group-hover:border-purple-200 transition-colors">
                      {h}
                    </span>
                  ))}
                </div>
