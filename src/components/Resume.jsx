      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        >
          <h2 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-black text-gray-900 leading-tight">
            Resume & <span className="bg-gradient-to-r from-purple-600 via-purple-500 to-purple-500 bg-clip-text text-transparent">Credentials</span>
          </h2>
        ...
        <motion.div
          ...
          className="relative rounded-[2rem] overflow-hidden bg-white border border-purple-100 shadow-sm shadow-purple-100"
        >
          <div className="grid grid-cols-1 lg:grid-cols-5">
            <div className="lg:col-span-3 p-6 sm:p-8 lg:p-10">
              <div className="flex items-start justify-between mb-6">
                <div>
                  ...
                  <p className="text-purple-600 font-semibold mt-1">Full Stack & AI/ML Developer</p>
                </div>
                <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-2xl bg-gradient-to-br from-purple-500 to-purple-600 flex items-center justify-center shadow-lg shadow-purple-500/30 flex-shrink-0">
              ...
              <div className="mb-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {[
                    ...
                    <span key={skill} className="text-xs px-3 py-1.5 rounded-full bg-purple-50 border border-purple-100 text-gray-700">
                      {skill}
                    </span>
                  ))}
                </div>
            ...
            <div className="lg:col-span-2 bg-purple-50/50 border-t lg:border-t-0 lg:border-l border-purple-100 p-6 sm:p-8 lg:p-10 flex flex-col justify-between">
              <div>
                ...
                <div className="space-y-6">
                  <div className="relative pl-6 border-l-2 border-purple-200">
                    <div className="absolute -left-[5px] top-1.5 w-2 h-2 rounded-full bg-purple-500 shadow-lg shadow-purple-500/50" />
                    ...
                    <p className="text-purple-600 text-xs mt-1 font-medium">04/2026 – Present</p>
                  ...
                  <div className="relative pl-6 border-l-2 border-purple-200">
                    ...
                    <p className="text-purple-500 text-xs mt-1 font-medium">03/2025 – 03/2026 (1 Year)</p>
                    <p className="text-gray-500 text-xs mt-2 leading-relaxed">
                ...
                <div className="mt-8">
                  ...
                  <div className="space-y-3">
                    <div>
                      ...
                      <p className="text-purple-600 text-xs">CGPA: 3.59 | 2022 – 2025</p>
                    </div>
                    <div>
                      ...
                      <p className="text-purple-600 text-xs">Marks: 998/1100 | 2020 – 2022</p>
                    </div>
                    <div>
                      ...
                      <p className="text-purple-600 text-xs">Marks: 996/1100 | 2018 – 2020</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-8 pt-6 border-t border-purple-100">
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 px-6 py-3.5 bg-gradient-to-r from-purple-600 to-purple-500 hover:from-purple-700 hover:to-purple-600 rounded-xl text-white font-semibold text-sm shadow-lg hover:shadow-purple-500/30 transition-all"
                >
