...
const verifications = [
  {
    name: "GitHub",
    desc: "Open source contributions and project repositories",
  ...
  {
    name: "LinkedIn",
    desc: "Professional network and recommendations",
  ...
  {
    name: "WhatsApp",
    desc: "Direct chat for business inquiries",
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        >
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black text-gray-900">
            <span className="bg-gradient-to-r from-purple-600 to-purple-400 bg-clip-text text-transparent">Online Verification</span>
          </h2>
          <p className="text-gray-600 mt-4 text-sm sm:text-base max-w-2xl mx-auto">
            Verified profiles and active presence on trusted platforms.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          {verifications.map((v, i) => (
            <motion.a
              ...
              whileHover={{ y: -6 }}
              className="flex flex-col items-center p-8 rounded-3xl bg-white border border-purple-100 shadow-sm shadow-purple-100 hover:shadow-md hover:shadow-purple-200 transition-all text-center"
            >
