...
export default function Contact() {
  return (
    ...
    >
      ...
      <motion.div
        className="absolute w-72 h-72 bg-pink-500/15 rounded-full blur-3xl top-10 left-10"
      ...
      <motion.div
        ...
        className="w-full max-w-xl sm:max-w-2xl bg-white/[0.03] backdrop-blur-2xl border border-white/10 rounded-[2rem] p-6 sm:p-8 lg:p-10 shadow-2xl relative z-10"
      >
        <div className="text-center mb-8 sm:mb-10">
          <motion.h2
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            className="text-3xl sm:text-4xl lg:text-5xl font-black bg-gradient-to-r from-white via-gray-200 to-purple-400 bg-clip-text text-transparent"
          >
            Let&apos;s Discuss Your <span className="bg-gradient-to-r from-cyan-400 to-purple-500 bg-clip-text text-transparent">Project</span>
          </motion.h2>
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <input
              ...
              required
              className="w-full p-4 bg-white/[0.04] border border-white/10 rounded-xl focus:border-purple-400 focus:ring-2 focus:ring-purple-400/30 outline-none text-white placeholder-gray-500 text-sm sm:text-base transition"
            />
            <input
              name="email"
              type="email"
              ...
              required
              className="w-full p-4 bg-white/[0.04] border border-white/10 rounded-xl focus:border-blue-400 focus:ring-2 focus:ring-blue-400/30 outline-none text-white placeholder-gray-500 text-sm sm:text-base transition"
            />
          </div>
          <textarea
            name="message"
            ...
            required
            className="w-full p-4 bg-white/[0.04] border border-white/10 rounded-xl focus:border-pink-400 focus:ring-2 focus:ring-pink-400/30 outline-none resize-none text-white placeholder-gray-500 text-sm sm:text-base transition"
          />
          <button
            type="submit"
        ...
        <div className="mt-8 pt-6 border-t border-white/10 flex flex-col items-center gap-4">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <a
              ...
              className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-green-500/10 border border-green-400/30 rounded-xl text-green-300 hover:bg-green-500/20 hover:text-white text-sm font-medium transition-all"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-white/5 border border-white/10 rounded-xl text-gray-300 hover:bg-white/10 text-sm font-medium transition-all"
            >
              Quick Message
            </a>
          </div>
